 ...
 * @author RedCa
 */
public class VistaLeon extends javax.swing.JFrame {
    ...
    public VistaLeon() {
     ...
     public VistaLeon(Controlador c) {
        initComponents();
        ...
        // Atributos Aliado
        String accionEn = lobo.getAccion();
        String armaEn = lobo.getArma();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Separador sep = new Separador(playSet);
        sep.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaLeon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
